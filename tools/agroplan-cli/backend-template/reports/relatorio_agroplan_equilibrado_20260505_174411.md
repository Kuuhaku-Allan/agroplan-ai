...
O plano recomendado buscou equilíbrio entre retorno financeiro, controle de risco e compatibilidade agronômica.
...
|---------|-------------|-------------|---------------------|
| **🧬 AG Equilibrado** | **R$ 866.770,00** | **31.5%** | **Cana + Sorgo + Soja + Café + Trigo + Sorgo + Feijão + Milho + Arroz + Mandioca** |
