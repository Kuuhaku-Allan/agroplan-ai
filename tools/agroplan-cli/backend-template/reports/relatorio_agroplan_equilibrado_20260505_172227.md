...
- **Talhão 8** (11 ha): **MILHO**
  - Lucro estimado: R$ 110,550.00
  - Risco: 35%
...
O algoritmo genético encontrou um plano equilibrado entre lucro, risco e compatibilidade do terreno. A solução mantém alto retorno financeiro (R$ 866,770.00) sem ultrapassar níveis críticos de risco (31.5%). O plano utiliza 9 culturas diferentes, oferecendo boa diversificação. Fitness final: 74.40.
...
|---------|-------------|-------------|---------------------|
| **🧬 AG Equilibrado** | **R$ 866,770.00** | **31.5%** | **Cana + Sorgo + Soja + Cafe + Trigo + Sorgo + Feijao + Milho + Arroz + Mandioca** |
...
**Por que cana foi escolhida para este talhão?**
...
- **Nota de compatibilidade:** 79.20/100
- **Lucro estimado:** R$ 140,000.00
- **Risco:** 38%
...
- **Água baixa:** Atende às necessidades hídricas
- **Nota de compatibilidade:** 63.88/100
- **Lucro estimado:** R$ 53,460.00
- **Risco:** 20%
