...
O plano recomendado reduziu a exposição média ao risco dentro das restrições do modelo.
...
|---------|-------------|-------------|---------------------|
| **🧬 AG Risco** | **R$ 790.240,00** | **31.8%** | **Algodão + Sorgo + Milho + Café + Trigo + Mandioca + Feijão + Soja + Arroz + Mandioca** |
| Equilibrado | R$ 853.730,00 | 28.2% | Trigo + Soja + Arroz + Mandioca + Sorgo + Milho |
| Máximo Lucro | R$ 1.638.000,00 | 38.0% | Cana |
| Baixo Risco | R$ 692.640,00 | 18.0% | Mandioca |
| Sustentável | R$ 768.720,00 | 25.2% | Trigo + Soja + Arroz + Mandioca + Sorgo |
| Conservador | R$ 826.000,00 | 24.6% | Soja + Mandioca + Sorgo |
...
**Por que algodão foi escolhida para este talhão?**
...
**Por que feijão foi escolhida para este talhão?**
...
- **Solo misto:** Compatível com as necessidades da cultura
- **Clima ameno:** Adequado para o desenvolvimento
- **Relevo íngreme:** Favorável ao cultivo
- **Água baixa:** Atende às necessidades hídricas
- **Nota de compatibilidade:** 64.06/100
- **Lucro estimado:** R$ 76.960,00
- **Risco:** 18%
